...
while (conntinueLopp) {
    //*********************************************** OPERATION OPTIONS ***************************************************/   
    let opertionalOptions = await inquirer.prompt([
        {
            name: "options",
            type: "list",
    ...
    if (opertionalOptions.options == "Deposit") {
        let answersDeposit = await inquirer.prompt([
            {
                name: "options",
                type: "number",
    ...
    if (opertionalOptions.options == "Withdrawls") {
        let answersWithdrawl = await inquirer.prompt([
            {
                name: "options",
                type: "list",
                message: "Select Your Options : ",
        ...
        if (answersWithdrawl.options == "Fast Cash") {
            let answersFast = await inquirer.prompt([
                {
                    name: "options",
                    type: "list",
                    message: "Select Your Options : ",
            ...
            let answersOther = await inquirer.prompt([
                {
                    name: "options",
                    type: "input",
    ...
    if (opertionalOptions.options == "Transfer") {
        ...
        if (answers.options == "Bank Account") {
            let answersTransfer = await inquirer.prompt([
                {
                    name: "acno",
                    type: "number",
                    default: "1234-33443434344-1",
            ...
            let answersMobWallet = await inquirer.prompt([
                {
                    name: "wallets",
                    type: "list",
